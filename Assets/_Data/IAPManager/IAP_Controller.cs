...
namespace Rubik.IAP
{
    ...
    {
        public static string API_Buy = "/api/multiplayer/iap/buy";
        public static string API_Restore = "/api/multiplayer/iap/restore";

        public const string IAP_ScoopTinyTicket = "com.nexworld.scooptinyticketnormal";
    }
    ...
    public class IAP_Controller : NTBehaviour
    {
        ...
        public IEnumerator IEBuy(string productID, string packageId, string transactionID, Action<bool> callback)
        {
            ...
            // jdata["userID"] = Rubik.UserData.UserDataManager.Instance.GetUserId();
